...
async function fetchSynopsis(outline) {
  const response = await openai.createCompletion({
    model: "text-davinci-003",
    prompt: `Generate an engaging, professional and marketable movie synopsis based on an outline. The synopsis should include actors' names in brackets after each character. Choose no fewer than 3 actors that would particularly suit the role. This should only be one paragraph in length.
    ###
